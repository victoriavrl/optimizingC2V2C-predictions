...
def create_inputs(ev_path, smart_charging, public, oracle):
    ...
    ev = (ev_class(name, input_trips, battery_capacity, user_type) if not oracle else
          ev_class(name, input_trips, battery_capacity, user_type, oracle=True)) \
